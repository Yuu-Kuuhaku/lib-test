...
@Component({
  selector: 'ngx-find-image-zoom',
  templateUrl: './ngx-image-zoom-new.component.html',
  styleUrls: ['./ngx-image-zoom-new.component.scss']
})
export class NgxImageZoomNewComponent implements OnInit, OnChanges, OnDestroy {
  ...
  public set setZoomMode(zoomMode: string) {
    if (NgxImageZoomNewComponent.validZoomModes.some(m => m === zoomMode)) {
